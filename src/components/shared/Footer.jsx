      ...
      <div className="container pt-5 pb-3">
        <div className="row d-flex">
          <div className="col-lg-4 col-md-4 col-sm-12 text-center mb-2">
            <h4 className="mb-4">Gravity Tech</h4>
            <p className="fs-6 description text-justify">
              Gravity Tech was launched in the year 2016. Within this short span
              of time, we have mastered the craft of Web Development, App
          ...
          <div className="col-lg-4 col-md-4 col-sm-12 text-center mb-2">
            <h4 className="mb-4">Office Address</h4>
            <div className="d-flex mb-3">
              ...
              <div className="description text-justify">
                Flat No.1, Deepashri Society, Building No 2, Mhatre Bridge, opp.
                Reliance Mall, Vakil Nagar, Erandwane, Pune, Maharashtra 411004
              </div>
            </div>
            <div className="d-flex mb-3">
              <div className="me-3">
              ...
              <div>
                <a
                  ...
                  href="mailto:info@gravitytech.co.in"
                >
                  info@gravitytech.co.in
                </a>
              </div>
            </div>
            <div className="d-flex mb-3">
              ...
              <div className="description text-start">(+91) 8459694413</div>
            </div>
          </div>
        </div>
      </div>
